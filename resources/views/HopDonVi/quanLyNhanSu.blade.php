                                ...
                                <div class="card-body">
                                    <div class="infomation">
                                        ...
                                        <div class='row '>
                                            ...
                                            <div class="col-md-4 d-flex justify-content-between align-items-center">
                                                <label style="padding-right: 18px" for="staticEmail" class="col-form-label">Khối đơn vị</label>
                                            ...
                                            <div class="col-md-4 d-flex justify-content-between align-items-center">
                                                <label style="padding-left: 10px" for="staticEmail" class="col-form-label">Trưởng bộ phận</label>
                                                <select data-width="55%" class="selectpicker" multiple>
                                        ...
                                        <div class='row mt-3'>
                                            <div id="date_time-hopgiaoban" class=" col-md-4 d-flex align-items-center justify-content-between datetimepicker_wrapper">
                                                <label for="reason">Ngày yêu cầu</label>
                                                <input style="width: 65%" type="text" value="<?php echo date('d/m/Y'); ?>" class="form-control date start" />
                                            </div>
                                            <div class="col-md-8 form-group d-flex align-items-center justify-content-between">
                                                <label for="reason">Mô tả công việc</label>
                                                <textarea style="width: 78%" class="form-control" aria-label="With textarea"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="infomation">
                                        ...
                                        <div class='row'>
                                            <div class="col-md-3 d-flex justify-content-between align-items-center">
                                                ...
                                                <input style="width: 60%" type="text" class="form-control" id="inputZip">
                                            </div>
                                            <div class="col-md-3 d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="col d-flex align-items-center">
                                                <div class="form-check d-flex align-items-center">
                                                    <input style="margin-right: 6px" class="form-check-input" type="checkbox" id="gridCheck">
                                        ...
                                        <div class='row' style="margin-top: 18px">
                                            ...
                                            <div class="col d-flex align-items-center">
                                                <label for="inputZip" class="form-label" style="margin-right: 4px">SL</label>
                                                <input style="width: 40%" type="text" class="form-control" id="inputZip">
                                            </div>
                                            <div class="col d-flex align-items-center">
                                        ...
                                        <div class='row' style="margin-top: 18px">
                                            ...
                                            <div id="date_time-hopgiaoban" class="col d-flex align-items-center justify-content-between datetimepicker_wrapper">
                                                <label for="reason">Ngày cần NS</label>
                                                <input style="width: 56%" type="text" value="<?php echo date('d/m/Y'); ?>" class="form-control date start" />
                                            </div>

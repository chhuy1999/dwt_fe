        ...
        <div class="mainSection">
            <div class="main">
                <div class="container-fluid">
                    ...
                    <div class="mx-auto" style="max-width: 24cm">
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="modal-body" style="padding: 0; margin: 1.5cm 1.5cm 1.5cm 2cm">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-4 d-flex align-items-center">
                                            <h5 class="modal-title w-100 fs-3 text-center ">Chi tiết đào tạo
                                            </h5>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="row align-items-center">
                                        ...
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <table id="dsDaoTao" class="table table-responsive table-hover table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr data-bs-toggle="modal" data-bs-target="#thongTinDaoTao" role="button">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 d-flex flex-column justify-content-between">
                                            <div class="d-flex align-items-center justify-content-center">
                                                <div class="mt-3 modal_body-title fw-bolder">Người hướng dẫn</div>
                                            </div>
                                            <div class="d-flex align-items-center  justify-content-center">
                                        ...
                                        <div class="col-md-6 d-flex flex-column justify-content-between">
                                            <div class="d-flex align-items-center justify-content-center">
                                                <div class="mt-3 modal_body-title fw-bolder">Học viên</div>
                                            </div>
                                            <div class="d-flex align-items-center  justify-content-center">
                                                <p class="modal_body-title">(Ký và ghi rõ họ tên)</p>
                                            </div>

...
@section('footer-script')
    ...
    <script type="text/javascript" src="{{ asset('/assets/js/chart_kinhdoanh/StackedChart_doanhSoKhachHangPhoThong.js') }}"></script>
    <script type="text/javascript" src="{{ asset('/assets/js/chart_kinhdoanh/StackedChart_doanhSoKhachHangSystem.js') }}"></script>
    <script type="text/javascript" src="{{ asset('/assets/js/chart_kinhdoanh/StackedChart_soKhachHangActive.js') }}"></script>
    <script type="text/javascript" src="{{ asset('/assets/js/chart_kinhdoanh/StackedChart_soKhachHangMoMoi.js') }}"></script>

                                    ...
                                    <div class='row'>
                                        <div class="col-md-12">
                                            <div class="table-responsive dataTables_wrapper">
                                                <table id="dsCapNhanSu" class="table table-responsive table-hover table-bordered">
                                                    <thead>
                                                        <tr class="bg-light">
                                                    ...
                                                    <tbody>
                                                        @foreach ($data->data as $value)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="table_actions d-flex justify-content-center">
                                                                        <div class="btn" data-bs-toggle="modal" data-bs-target="#suacapnhansu{{ $value->id }}">
                                                                            <img style="width:16px;height:16px" src="{{ asset('assets/img/edit.svg') }}" />
                                                                        </div>
                                                                        <div class="btn" data-bs-toggle="modal" data-bs-target="#xoacapnhansu{{ $value->id }}">
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <form action="{{ route('positionLevel.delete', $value->id) }}" method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
                                                            ...
                                                            <div class="modal fade" id="suacapnhansu{{ $value->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">

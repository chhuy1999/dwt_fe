            ...
            <div class="main p-0">
                <div class="card mb-3">
                    <div class="" style="margin: 2px">
                        <div class="container-fluid mainSection_heading d-flex row pt-3" style="max-height: 60px; border-bottom: 3px solid var(--primary-color);">
                        ...
                        <div class="mainSection_heading row" style="border-bottom: 1px dashed #000">
                            <div class="col-6">
                                <div class="row" >

                        ...
                        <div class="mainSection_heading row" style="margin: 0">
                            ...
                            <div class="card col-sm-4 ">
                                <div class="row d-flex align-items-center" >
                                    ...
                                    <div class="col-6 d-flex">
                                        <div class="">
                                            <img class="" style="width: 30px; height: 30px" src="{{ asset('assets/img/12.png') }}" />

                                        </div>
                                        <div class="">
                                            <img class="" style="width: 30px; height: 30px" src="{{ asset('assets/img/13.png') }}" />

                                        </div>
                                        <div class="">
                                            <img class="" style="width: 30px; height: 30px" src="{{ asset('assets/img/14.png') }}" />

                                        </div>
                                        <div class="">
                                            <img class="" style="width: 30px; height: 30px" src="{{ asset('assets/img/15.png') }}" />

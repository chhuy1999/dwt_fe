        ...
        <div class="mainSection">
            <div class="main p-0">
                <div class="card mb-3">
                    ...
                    <div class="mainSection_heading mt-3" style="margin: 0">
                        ...
                        <div class="col-sm-4 ">
                            ...
                            <div class="row d-flex">
                                <div class="card col-3 mx-1" style="width: 24%">
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <p class=" " style="text-align: center; font-size: 10px;" >Avg Leave Bal CY v PY</p>
                                        </div>
                            ...
                            <div class="row d-flex mt-1">
                                <div class="card col-3 mx-1" style="width: 24%">
                                    <div class="row">
                                        <div class="col-6">
                                            <p class=" " style="text-align: center; font-size: 10px; color: #454545; padding-right: 0" >CY 21 Days</p>
                                            
                                        </div>
                                        <div class="col-6">
                                            <p class=" " style="text-align: center; font-size: 10px; color: #454545; padding-right: 0" >PY 22 Days</p>
                                        </div>

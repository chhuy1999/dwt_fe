                        ...
                        <div class="col-sm-4 ">
                            ...
                            <div class="row d-flex">
                                <div class="card col-3">
                                    <div class="row">
                                        <div class="col-4">
                                            <img class="" style="width: 40px; height: 40px; color='#000'" src="{{ asset('assets/img/16.png') }}" />
                                            
                                        </div>
                                        <div class="col-8">
                                            <p class="card-title " style="text-align: center; font-size: 10px;" >Avg Leave Bal CY v PY</p>
                                        </div>

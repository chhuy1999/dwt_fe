                            ...
                            <div class="card col-sm-4 ">
                                ...
                                <div class="">
                                    <div class="row d-flex">
                                        ...
                                        <div class="card-title ">Revenue Trend Qtr YTD</div>
                                        <div class="">
                                            <div class="">
                                                <img class="" style="width: 70px; height: 50px" src="{{ asset('assets/img/sua.png') }}" />
    
                                            </div>
                                            <div class="">
                                                <img class="" style="width: 70px; height: 50px" src="{{ asset('assets/img/kinhlup.png') }}" />
    
                                            </div>
                                            <div class="">
                                                <img class="" style="width: 70px; height: 50px" src="{{ asset('assets/img/10.png') }}" />
    
                                            </div>
                                            <div class="">
                                                <img class="" style="width: 70px; height: 50px" src="{{ asset('assets/img/11.png') }}" />

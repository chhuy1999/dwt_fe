        ...
        <div class="mainSection">
            <div class="main p-0">
                <div class="card mb-3">
                    ...
                    <div class="mainSection_heading row mt-3" style="margin: 0">
                    ...
                    <div class="mainSection_heading mb-3" style="margin: 0">
                        
                        <div class="col-sm-4 ">
                            <div class="card-title col-6 me-auto">Employee Trend Qtr YTD</div>
                            <div class="row d-flex mt-3">
                                <div class="card col-3 mx-1 " style="width: 24%">
                                    <div class="row">
                                        <div class="col-4">
                                            <img class="" style="width: 40px; height: 40px;" src="{{ asset('assets/img/16.png') }}" />
                                            
                                        </div>
                                        <div class="col-8">
                                            <p class=" mb-0" style="text-align: center; font-size: 10px;" >Avg Leave Bal CY v PY</p>
                                        </div>
                                ...
                                <div class="card col-3 mx-1" style="width: 24%">
                                    <div class="row">
                                        <div class="col-4">
                                            <img class="" style="width: 40px; height: 40px;" src="{{ asset('assets/img/17.png') }}" />
                                            
                                        </div>
                                        <div class="col-8">
                                            <p class=" " style="text-align: center; font-size: 10px;" >Overtime CY v PY $</p>
                                        </div>
                                ...
                                <div class="card col-3 mx-1" style="width: 24%">
                                    <div class="row">
                                        <div class="col-4">
                                            <img class="" style="width: 40px; height: 40px;" src="{{ asset('assets/img/18.png') }}" />
                                            
                                        </div>
                                        <div class="col-8">
                                            <p class=" " style="text-align: center; font-size: 10px;" >Cost to Hire</p>
                                        </div>
                                ...
                                <div class="card col-3 mx-1" style="width: 24%">
                                    <div class="row">
                                        <div class="col-4">
                                            <img class="" style="width: 40px; height: 40px;" src="{{ asset('assets/img/19.png') }}" />
                                            
                                        </div>
                                        <div class="col-8">
                                            <p class=" " style="text-align: center; font-size: 10px;" >Open Positions</p>
                                        </div>
                            ...
                            <div class="row d-flex mt-1">
                                <div class="card col-3 mx-1" style="width: 24%">
                                    <div class="row">
                                        <div class="col-6">
                                            <p class="" style="text-align: center; font-size: 10px; color: #454545" >CY 21 Days</p>
                                            
                                        </div>
                                        <div class="col-6">
                                            <p class=" " style="text-align: center; font-size: 10px; color: #454545" >PY 22 Days</p>
                                        </div>
                                ...
                                <div class="card col-3 mx-1" style="width: 24%">
                                    <div class="row">
                                        <div class="col-6">
                                            <p class=" " style="text-align: center; font-size: 10px; color: #454545" >CY 56k</p>
                                            
                                        </div>
                                        <div class="col-6">
                                            <p class=" " style="text-align: center; font-size: 10px; color: #454545" >PY 46k</p>
                                        </div>
                                ...
                                <div class="card col-3 mx-1" style="width: 24%">
                                    <div class="row">
                                        <div class="col-6">
                                            <p class=" " style="text-align: center; font-size: 10px; color: #454545" >CY 6764</p>
                                            
                                        </div>
                                        <div class="col-6">
                                            <p class=" " style="text-align: center; font-size: 10px; color: #454545" >PY 6009</p>
                                        </div>
                                ...
                                <div class="card col-3 mx-1" style="width: 24%">
                                    <div class="row">
                                        <div class="col-6">
                                            <p class=" " style="text-align: center; font-size: 10px; color: #454545" >CY 17</p>
                                            
                                        </div>
                                        <div class="col-6">
                                            <p class=" " style="text-align: center; font-size: 10px; color: #454545" >PY 20</p>
                                        </div>
                            ...
                            <div class="row d-flex mt-1 ">
                                <div class=" col-3 mx-1 align-items-center" style="width: 24%">
                                    <i class="bi bi-caret-down-fill"></i>02% Prior Yr
                                    
                                </div>
    
                                <div class=" col-3 mx-1" style="width: 24%">
                                    <i class="bi bi-caret-up-fill"></i>23% Prior Yr
                                    
                                </div>
    
                                <div class=" col-3 mx-1" style="width: 24%">
                                    <i class="bi bi-caret-up-fill"></i>13% Prior Yr
                            ...
                            <div class="card-title col-6 me-auto mt-3">Staffing Trends Qtr YTD</div>
                            <div class="row d-flex mt-3">
                                <div class="card col-3 mx-1 " style="width: 24%">
                                    <div class="row">
                                        <div class="col-4">
                                            <img class="" style="width: 40px; height: 40px;" src="{{ asset('assets/img/20.png') }}" />
                                            
                                        </div>
                                        <div class="col-8">
                                            <p class=" mb-0" style="text-align: center; font-size: 10px;" >Leads by Employees</p>
                                        </div>
                                ...
                                <div class="card col-3 mx-1" style="width: 24%">
                                    <div class="row">
                                        <div class="col-4">
                                            <img class="" style="width: 40px; height: 40px;" src="{{ asset('assets/img/21.png') }}" />
                                            
                                        </div>
                                        <div class="col-8">
                                            <p class=" " style="text-align: center; font-size: 10px;" >Staff Performance</p>
                                        </div>
                                ...
                                <div class="card col-3 mx-1" style="width: 24%">
                                    <div class="row">
                                        <div class="col-4">
                                            <img class="" style="width: 40px; height: 40px;" src="{{ asset('assets/img/22.png') }}" />
                                            
                                        </div>
                                        <div class="col-8">
                                            <p class=" " style="text-align: center; font-size: 10px;" >Staff  Sales Conversion</p>
                                        </div>
                                ...
                                <div class="card col-3 mx-1" style="width: 24%">
                                    <div class="row">
                                        <div class="col-4">
                                            <img class="" style="width: 40px; height: 40px;" src="{{ asset('assets/img/23.png') }}" />
                                            
                                        </div>
                                        <div class="col-8">
                                            <p class=" " style="text-align: center; font-size: 10px;" >Staff Efficiency</p>
                                        </div>
                        ...
                        <div class="col-sm-4 ">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="card-title">KeyOtherChart_Scatter</div>
                                </div>
                                <div class="mainSection_chart-container mt-3">
                                    <canvas id="KeyOtherChart_Scatter"></canvas>
                                </div>
                            </div>
                        </div>
